	...
	<div class="main-content">
		...
		<div class="page-content home-page">
			...
			<div class="container__right-content">
				...
				<thead>
				    <tr style="background: #009ceb; color: #ffffff;">
				...
				<tbody>
					...
					<tr>
						...
						<a id="btnDeleteImage" data-id="${item.imageId}" style="pointer-events: all;"> <i style="color: red;" class=" icon fas fa-trash-alt"></i></a>                        	                               
					    </td>             
					</tr>
				    </c:forEach>
				</tbody>
